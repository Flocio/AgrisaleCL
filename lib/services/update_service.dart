    ...
    try {
      final response = await http.get(
        ...
        headers: {
          ...
          'User-Agent': 'AgrisaleCL-Update-Checker/${AppVersion.versionForUserAgent}',
        },
  ...
  static String? _getDownloadUrl(List assets, String platform, String? proxyBase) {
    if (platform == 'android') {
      ...
      for (var asset in assets) {
        ...
        if (assetName.startsWith('agrisalecl-android-') && assetName.endsWith('.apk')) {
          apkUrl = originalUrl;
        } else if (assetName.startsWith('agrisalecl-android-') && assetName.endsWith('.aab')) {
          aabUrl = originalUrl;
        }
      }
